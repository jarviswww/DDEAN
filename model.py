...
class DDEAN(Module):
    def __init__(self, opt, num_node):
        ...
        self.temp_same = opt.temp1
        self.temp_cross = opt.temp2
        self.theta1 = opt.theta1
        self.theta2 = opt.theta2
        ...
        self.sameCl_s = ContrastiveLoss(self.batch_size, self.temp_same)
        self.sameCl_l = ContrastiveLoss(self.batch_size, self.temp_same)
